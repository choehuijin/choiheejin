...
전화 상담 희망시 기재 부탁드립니다." required>${boardVO.content}</textarea></div>
                  ...
                  <li class="clear">
                     ...
                     <div class="app_content"><input value="${board.writer}" name="writer" type="text" class="w100p" id="name_lbl" placeholder="이름을 입력해주세요" required/></div>
                  </li>
                  <li class="clear">
               ...
               <button onclik="location.href='/board/list'; return false;" class="btn_baseColor">목록</button>
               <!-- onclick="location.href='/board/list'" -> 자바스크립트로 경로를 잡을때 사용한다. -->
               </p>   
            </fieldset>
