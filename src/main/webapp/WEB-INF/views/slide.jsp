...
body header {
	background: url(/resources/images/header.jpg) no-repeat 50% 55%;
...
<body>
	<header>
		<div class="row">
			<h1 id="brand">
				<a href="javascript:;">choiheejin</a>
			</h1>
			<div class="hamberger">
	...
	<!-- e:header-->
	<script src="//cdnjs.cloudflare.com/ajax/libs/jquery-nivoslider/3.2/jquery.nivo.slider.js"></script>
  <link href="//cdnjs.cloudflare.com/ajax/libs/jquery-nivoslider/3.2/nivo-slider.css" media="screen" rel="stylesheet" type="text/css">
  <script type="text/javascript">
	...
	<section id="contents" class="row">
		<article id="main">
			...
			<ul>
				<li class="clearfix"><img class="col-4"
					src="/resources/images/dog.jpg" alt="" width="296" height="206" />
				...
				<li class="clearfix"><img class="col-8 fr last"
					src="/resources/images/dog.jpg" alt="" width="620" height="416" />
					<div class="col-4">
		...
		<article id="sub" class="row clearfix">
			...
			<ul>
				<li class="col-3"><img src="/resources/images/dog.jpg"
				...
				<li class="col-6 last"><img src="/resources/images/dog.jpg"
